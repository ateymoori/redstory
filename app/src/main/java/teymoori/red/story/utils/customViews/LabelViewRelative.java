...
public class LabelViewRelative extends LinearLayout {
    LabelViewHelper utils;
    public LabelViewRelative(Context context) {
        this(context, null);
    }
    public LabelViewRelative(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public LabelViewRelative(Context context, AttributeSet attrs, int defStyleAttr) {
